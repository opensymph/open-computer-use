...
read_package_version() {
  (cd "${repo_root}/scripts/releasetool" && go run . version "${repo_root}/plugins/open-computer-use/.codex-plugin/plugin.json")
}
...
cursor_reference_source="${repo_root}/assets/cursor/official-software-cursor-window-252.png"
